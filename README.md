...
3. Найдите и напишите боту @BotFather.

4. Используйте команду /newbot и следуйте инструкциям:

5. Укажите имя и юзернейм бота.

6. После создания BotFather пришлёт токен. Вставьте его в
```bash
#bot.py
TOKEN = "YOUR_TOKEN"
```
